...
- Add product detail pages with quantity controls, product information, related items, and add-to-cart actions.
- Add a cart page with quantity updates, removal, totals, empty state, and checkout placeholder.
...
- Define the visual system in Tailwind theme tokens and include unique page metadata.
- Verify shop, category, product, and cart interactions in the browser at desktop and mobile sizes.