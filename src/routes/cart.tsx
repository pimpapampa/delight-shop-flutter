...
function CartPage() {
  ...
  if (!cart.length) return <div className="mx-auto flex min-h-[55vh] max-w-xl flex-col items-center justify-center px-5 text-center"><ShoppingBasket className="size-14 text-primary" /><h1 className="mt-5 font-display text-4xl">Your basket is empty</h1><p className="mt-3 text-muted-foreground">There’s always room for one more sweet thing.</p><Button asChild size="lg" className="mt-7"><Link to="/shop" search={{}}>Browse the shop</Link></Button></div>;
